...
Ámbito: recuperación asincrónica asistida; las predicciones y reflexiones técnicas son del agente asistente. No se dispone de las ejecuciones del instructor ni de predicciones personales de Alberto. No se afirma asistencia ni equivalencia con participación sincrónica.

Entorno elegido: Python 3.12 y uv, por requisito docente y familiaridad; biblioteca estándar suficiente para pruebas locales y datos sintéticos. No se ofrece servicio web, autenticación real, persistencia productiva ni facturación. No se usan datos personales ni credenciales nuevas. Git lo administra el coordinador del proyecto; no se publica remoto.
...
Prueba de cierre: casos de contraseña y email de la guía, dos usuarios, petición administradores, reproducción de cualquier inconsistencia observable, y comparación fiel con las predicciones prospectivas. Se conserva salida CLI y una segunda ejecución independiente. La captura visual será de esas salidas reales, no una terminal recreada.
